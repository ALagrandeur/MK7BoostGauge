...
class PcConfig:
    ...
    def load(self) -> None:
        if self.path.exists():
            ...
            self.save()  # Create the file immediately
    ...
    def get_pi_config_only(self) -> dict:
        ...
        pi_keys = {"map_min_mbar", "map_max_mbar", "scale", "offset_c",
                   "tx_rate_hz", "test_mode_active", "test_mode_temp_c"}
        with self._lock:
